...
tst <- benchmarkSuite(niter = 10000, nparticles = 100000, nreps = 10, summarize = T, debug = T)
  
## only run MCMC benchmarks, using different numbers of iterations for each benchmark
tst <- benchmarkSuite(PFtests = NULL, niter = c(100000, 10000), nreps = 10, summarize = T, debug = T)
